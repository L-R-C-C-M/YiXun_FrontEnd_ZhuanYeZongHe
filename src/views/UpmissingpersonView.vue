  ...
  <el-container style="height: fit-content">
    ...
    <el-main>
      ...
      <div style="padding: 5px 10px 15px 500px">
        <el-form ref="upForm" :model="form" label-width="200px" justify="center" style="max-width: 500px" :rules="rules"
          status-icon>
          ...
          <el-form-item label="身高(厘米)">
            <el-input-number v-model="form.height" :min="1" :max="250" controls-position="right" @change="handleChange" />
          </el-form-item>
          ...
          <el-form-item label="上传照片">
            <div style="text-align: left">
              <UpMissImage @uploadImgSuccess="uploadImgSuccessHandler" />
          ...
          <el-form-item label="选择失散地点" prop="selectedOptions">
            <el-col :span="24">
              <el-cascader placeholder="请选择地区" size="default" :options="options" v-model="form.selectedOptions"
          ...
          <div style="text-align: center; padding: 5px 10px 15px 150px">
            <el-form-item>
              <el-button type="primary" @click="onSubmit('upForm')">发布</el-button>
            </el-form-item>
          </div>
        </el-form>
      </div>
...
import UpMissImage from '@/components/UpMissImage.vue'
