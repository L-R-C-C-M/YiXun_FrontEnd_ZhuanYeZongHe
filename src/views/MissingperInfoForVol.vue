      ...
      <el-main>
          ...
          <div>
            <div class="info">
              ...
              <div style="padding: 20px 0px 15px 5px" v-if="this.loginState">
                ...
                <el-button type="primary" round @click="findDialogVisible = true">
                  已 找 到
                </el-button>
                <el-dialog v-model="findDialogVisible" title="提示" width="40%">
                  <span>确认该寻人信息已找到？</span>
                  <template #footer>
                    <span class="dialog-footer">
                      <el-button @click="findDialogVisible = false">取 消</el-button>
                      <el-button type="primary" @click="havefound()">
                        确 认
                      </el-button>
                    </span>
                  </template>
        ...
        <el-row v-for="clue in this.MissInfo.search_clue" :key="clue.ClueContent">
          ...
          <div style="padding: 9px">
            ...
            <el-button v-else size="small" round @click="clueVerifyDialogVisible = true">
              核实
            </el-button>
            ...
            <el-dialog v-model="clueVerifyDialogVisible" title="提示" width="40%">
              ...
              <template #footer>
                <span class="dialog-footer">
                  ...
                  <el-button type="primary" @click="haveVerifide(clue.ClueId)">
                    确 认
                  </el-button>
                </span>
              </template>
        ...
        <div style="padding: 50px 0px 15px 75px">
          <el-form :model="clueForm" label-width="100px" style="max-width: 1500px">
            ...
            <el-button type="primary" class="actButton" round
              @click="upClueClick(clueForm.report_content)">发布线索</el-button>
