<template>
    <el-container style="height: fit-content">
        ...
        <el-main>
            <!-- 这里是页面内容 -->
            <!-- @author:郭静静-修改寻人信息界面内容 -->
            <!-- <el-page-header :icon="ArrowLeft" /> -->
            <div style="padding: 5px 10px 15px 500px">
                <el-form ref="upForm" :model="form" label-width="200px" justify="center" style="max-width: 500px"
                    :rules="rules" status-icon>
                    <el-form-item label="寻人类型" prop="type">
                        <el-col :span="24">
                            <el-select v-model="form.type" placeholder="请选择寻人类型" style="width: 100%">
                    ...
                    <el-form-item label="被寻人姓名/曾用名" prop="name">
                    ...
                    <el-form-item label="出生日期" prop="birthday">
                        <el-col :span="24">
                            <el-date-picker v-model="form.birthday" type="date" placeholder="请选择日期" style="width: 100%" />
                        </el-col>
                    </el-form-item>
              ...
              <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div> 
                    ...
                    <el-form-item label="上传照片">
                        <div style="text-align: left">
                            <el-upload class="avatar-uploader" action :auto-upload="false" ref="upload"
                    ...
                    <el-form-item label="是否报案" prop="y_n_report">
                    ...
                    <el-form-item label="失散日期" prop="date">
                        <el-col :span="24">
                            <el-date-picker v-model="form.date" type="date" placeholder="请选择日期" style="width: 100%" />
                        </el-col>
                    </el-form-item>

                    <el-form-item label="选择失散地点" prop="selectedOptions">
                        <el-col :span="24">
                            <el-cascader placeholder="请选择地区" size="default" :options="options"
                                v-model="form.selectedOptions" @change="handleChange" style="width: 100%">
                            </el-cascader>
                        </el-col>
                    </el-form-item>
                    ...
                    <el-form-item label="联系方式" prop="telephone">
                        <el-input v-model="form.telephone" placeholder="请输入联系人手机号" />
                    </el-form-item>

                    <div style="text-align: center; padding: 5px 10px 15px 150px">
                        <el-form-item>
                            <el-button type="primary" @click="onSubmit('upForm')">提交修改</el-button>
                        </el-form-item>
                    </div>
                </el-form>
            </div>
...
export default {
    data() {
        return {
            ...
            rules: {
                ...
                date: [{ required: true, message: "此项不能为空", trigger: "change" }],
                selectedOptions: [
                    { required: true, message: "此项不能为空", trigger: "change" },
                ],
                telephone: [
    ...
    mounted() {
        api
            .getMissingpersonInfoAll(this.MissID)
            .then((res) => {
                console.log("接收到的数据");
