<template>
  ...
  >
    ...
    <div class="select-information">
      ...
      <div class="select-item">
        <div class="type">失散地点/被寻人所在地</div>
        <div
          class="type2-content"
  ...
  methods: {
    SearchForLost () {
      ...
      if (this.selectedOptions[0])
        this.searchForm.province = this.selectedOptions[0];
      if (this.selectedOptions[1])
        this.searchForm.city = this.selectedOptions[1];
      if (this.selectedOptions[2])
        this.searchForm.area = this.selectedOptions[2];
